...
uint8_t dxl_id[DXL_NUM] = {DXL_ID_1, DXL_ID_2, DXL_ID_3, DXL_ID_4};
...
void loop() 
{  
  int32_t present_position[DXL_NUM] = {0, 0, 0, 0};
  float present_radian[DXL_NUM] = {0.0, 0.0, 0.0, 0.0};
  int32_t *get_data;
